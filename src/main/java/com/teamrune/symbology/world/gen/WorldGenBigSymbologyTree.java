...
public class WorldGenBigSymbologyTree extends WorldGenAbstractTree
{
    ...
    public WorldGenBigSymbologyTree(boolean p_i2008_1_)
    {
        super(p_i2008_1_);
    ...
    void generateLeafNodeList()
    {
        ...
        this.field_175948_j.add(new WorldGenBigSymbologyTree.FoliageCoordinates(this.field_175947_m.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.func_175936_a(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.field_175948_j.add(new WorldGenBigSymbologyTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    private BlockAshLog.EnumAxis func_175938_b(BlockPos p_175938_1_, BlockPos p_175938_2_)
    {
        BlockAshLog.EnumAxis enumaxis = BlockAshLog.EnumAxis.Y;
        ...
        if (k > 0)
        {
            if (i == k)
            {
                enumaxis = BlockAshLog.EnumAxis.X;
            }
            else if (j == k)
            {
                enumaxis = BlockAshLog.EnumAxis.Z;
            }
        }
    ...
    void func_175939_d()
    {
        ...
        while (iterator.hasNext())
        {
            ...
            {
                this.func_175937_a(blockpos, foliagecoordinates, Symbology.ash_log);
            }
        }
    }
    ...
    private boolean validTreeLocation()
    {
        ...
        boolean isSoil = state.getBlock().canSustainPlant(this.world, down, net.minecraft.util.EnumFacing.UP, (IPlantable) Symbology.ash_sapling);
